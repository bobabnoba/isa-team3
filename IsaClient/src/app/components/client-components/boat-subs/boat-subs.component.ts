...
@Component({
  selector: 'app-boat-subs',
  templateUrl: './boat-subs.component.html',
  styleUrls: ['./boat-subs.component.css']
})
export class BoatSubsComponent implements OnInit {
  ...
  constructor(
    ...
    this._subService.getClientBoatSubscriptions(this.clientEmail).subscribe({
      next: (res: any) => {
