...
@Component({
  selector: 'app-instructor-subs',
  templateUrl: './instructor-subs.component.html',
  styleUrls: ['./instructor-subs.component.css']
})
export class InstructorSubsComponent implements OnInit {
  ...
  constructor(
    ...
    this._subService.getClientInstructorsSubscriptions(this.clientEmail).subscribe({
      next: (res: any) => {
