...
@Component({
  selector: 'app-reservation-charts',
  templateUrl: './reservation-charts.component.html',
  styleUrls: ['./reservation-charts.component.css']
})
export class ReservationChartsComponent implements OnInit {
  labelsWeekBoat: any[] = [];
  ...
  constructor(private _pipe : DatePipe,
    private _reservationService : ReservationService, private _storageService: StorageService, private _boatService: BoatService) {
